...
<form name="form1" method="post">
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td  bgcolor="#666666"><table width="600" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <tr>
                    <td height="20" bgcolor="#FFFFFF"><div align="center">${user.name}</div></td>
                    ...
                    <td height="20" bgcolor="#FFFFFF"><div align="center">
                        <input type="checkbox" name="43" value=43></div></td>
                    <td height="20" bgcolor="#FFFFFF"><div align="center"><a href="lookUserinfo.html"><img src="images/button_select.png" width="14" height="13" border="0"></a></div></td>
                </tr>
                </c:forEach>
            </table></td>
        </tr>
    ...
    <table width="600" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td width="600" colspan="2"><div align="left">

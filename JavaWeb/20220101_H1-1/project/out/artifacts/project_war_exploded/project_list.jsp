    ...
    <tr>
        <td height="30" colspan="3">
            <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="33%" height="30" align="center" bgcolor="#FFFFFF"><span class="txt">${p.project_id}</span></td>
                    <td width="34%" height="30" align="center" bgcolor="#FFFFFF"><span class="txt">${p.project_name}</span></td>
                    <td width="33%" height="30" align="center" bgcolor="#FFFFFF"><span class="txt">
                        <a href="projectServlet?action=edit&project_id=${p.project_id}">【修改】</a>
                        <a href="projectServlet?action=del&project_id=${p.project_id}">【删除】</a>
                        【删除】
                    </span></td>
                </tr>
                </c:forEach>
